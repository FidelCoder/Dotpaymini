...
import { initiateBackendBuygoods } from "@/lib/api";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const transaction = await initiateBackendBuygoods({
    ...
    const message = error instanceof Error ? error.message : "Failed to initiate till payment.";
